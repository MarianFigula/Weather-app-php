...
<div class="container-sm p-2 mb-3 border rounded">
    <h3>Zadanie Adresy</h3>
    <hr>
        <div class="row mb-3">
            <input type="hidden" name="ip_address" id="hid-ip">
            <input type="hidden" name="address" id="hid-addr">
            <input type="hidden" name="country" id="hid-country">
            <input type="hidden" name="country_code" id="hid-country-code">
            <div class="form-group">
                <label for="address">Zadajte adresu miesta</label>
                <br>
                <input type="text" class="form-control" id="address" placeholder="">
            </div>

        </div>
        <button class="btn btn-primary" type="button" id="address-button" name="address-button">Potvrdiť</button>
</div>
